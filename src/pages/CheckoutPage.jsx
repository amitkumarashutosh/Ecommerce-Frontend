...
export default function CheckoutPage() {
  ...
  const onSubmit = (data) => {
    dispatch(
      updateUserAsync({
        ...currentUser,
        address: [...currentUser.address, data],
      })
    );
    reset();
  };
  ...
  const handleAddress = (e) => {
    setSelectedAddress(currentUser.address[e.target.value]);
  };
    ...
    <>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
          <div className="lg:col-span-3 lg:mb-6">
            <form className="bg-white px-6" onSubmit={handleSubmit(onSubmit)}>
              <div className="space-y-12">
                <div className="border-b border-gray-900/10 pb-12">
                  <h2 className="text-2xl font-semibold leading-7  text-gray-900 mt-12 pt-5">
          ...
          <div className="lg:col-span-2 mb-7">
                        ...
                        <div className="ml-4 flex flex-1 flex-col">
                          ...
                          <div className="flex flex-1 items-end justify-between text-sm">
                            ...
                            <div className="flex">
                              <button
                                type="button"
                                onClick={(e) => handleDeleteItem(product.id)}
